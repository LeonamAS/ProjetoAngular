...
app.post("/login", async (req: { body: { nome: any; senha: any; }; }, res: { status: (arg0: number) => { (): any; new(): any; json: { (arg0: { message?: string; id?: number; nome?: string; email?: string; error?: string; }): any; new(): any; }; }; }) => {
    try {
...
app.get("/vehicles", (req: any, res: { status: (arg0: number) => { (): any; new(): any; json: { (arg0: { vehicles?: { id: number; vehicle: string; volumetotal: number; connected: number; softwareUpdates: number; img: string; }[]; message?: string; }): any; new(): any; }; }; }) => {
    try {
        const vehicles = [
            {
                id: 1,
...
app.post("/vehicleData", (req: { body: { vin: any; }; }, res: { status: (arg0: number) => { (): any; new(): any; json: { (arg0: { id?: number; odometro?: number; nivelCombustivel?: number; status?: string; lat?: number; long?: number; message?: string; }): any; new(): any; }; }; }) => {
    try {
        const { vin } = req.body
